...
@push('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
        	...
        	$("#cari").click(function() {
                $("#form1").attr("action", "{{ url('laporan/itemkeluar') }}");
                $("#form1").submit();
            });

            $("#cetak").click(function() {
                $("#form1").attr("action", "{{ url('laporan/cetak/itemkeluar') }}");
                $("#form1").submit();
            });
        });
    </script>
            ...
            <div class="card-body" style="padding-bottom: 0px !important;">
                ...
                <div class="form-row">
                    <div class="form-group col-4">
                        ...
                        <input class="form-control" id="katakunci" name="katakunci" type="text" placeholder="masukkan kode item keluar..">
                    </div>
                    <div class="form-group col-4">
