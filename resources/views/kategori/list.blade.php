                    ...
                    <tbody>
                        ...
                        @foreach ($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>{{ App\Lib\Csql::cekStatusAktif($row->statuskategori) }}</td>
                                <td>
                                    <a class="btn btn-info btn-sm" href='{{ url("$prefix/edit/$row->kodekategori") }}'><i class="fa fa-edit"></i></a>
                                    {{-- <a class="btn btn-danger btn-sm" onclick="return confirm('Hapus data {{ $row->kodekategori }} ? ')" href='{{ url("/$prefix/acthapus/$row->kodekategori") }}'><i class="fa fa-trash"></i></a> --}}
                                </td>
                            </tr>
