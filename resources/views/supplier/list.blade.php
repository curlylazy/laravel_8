                    ...
                    <tbody>
                        ...
                        @foreach ($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>{{ $row->noteleponsupplier }}</td>
                                <td>{{ App\Lib\Csql::cekStatusAktif($row->statussupplier) }}</td>
                                <td>
                                    <a class="btn btn-info btn-sm" href='{{ url("$prefix/edit/$row->kodesupplier") }}'><i class="fa fa-edit"></i></a>
                                    {{-- <a class="btn btn-danger btn-sm" onclick="return confirm('Hapus data {{ $row->kodesupplier }} ? ')" href='{{ url("$prefix/acthapus/$row->kodesupplier") }}'><i class="fa fa-trash"></i></a> --}}
                                </td>
                            </tr>
