                    ...
                    <tbody>
                        ...
                        @foreach ($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>{{ $row->email }}</td>
                                <td>{{ $row->akses }}</td>
                                <td>{{ App\Lib\Csql::cekStatusAktif($row->statususer) }}</td>
                                <td>
                                    <a class="btn btn-info btn-sm" href='{{ url("$prefix/edit/$row->kodeuser") }}'><i class="fa fa-edit"></i></a>
                                    {{-- <a class="btn btn-danger btn-sm" onclick="return confirm('Hapus data {{ $row->kodeuser }} ? ')" href='{{ url("$prefix/acthapus/$row->kodeuser") }}'><i class="fa fa-trash"></i></a> --}}
                                </td>
                            </tr>
