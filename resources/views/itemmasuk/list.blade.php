                    ...
                    <tbody>
                        ...
                        @foreach ($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm" href='{{ url("$prefix/edit/$row->kodeitemmasuk") }}'><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-danger btn-sm" onclick="return confirm('Hapus data {{ $row->kodeitemmasuk }} ? ')" href='{{ url("$prefix/acthapus/$row->kodeitemmasuk") }}'><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
